...
# Build the bidirectional LSTM model
modelx = Sequential()
modelx.add(Bidirectional(LSTM(128, return_sequences=True), input_shape=(x1.shape[1], 1)))
...
# Build the bidirectional LSTM model
modely = Sequential()
modely.add(Bidirectional(LSTM(128, return_sequences=True), input_shape=(x2.shape[1], 1)))
...
# Build the bidirectional LSTM model
modelz = Sequential()
modelz.add(Bidirectional(LSTM(128, return_sequences=True), input_shape=(x3.shape[1], 1)))
