# -*- coding: utf-8 -*-
"""B-LSTM_Senario1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1461Vf7_svatJcdUQYGRw0htLPOOf5wOy
"""
...
input_file = "/content/Scenario1.csv"
...
split_index = int(train_percentage * len(x))       #case 1 m-a
#split_index=750                                   #case 2 i-a
#split_index=340                                   #case 3 e-a
...
modelx.fit(x1, y1, batch_size=1, epochs=10)
...
# Train the model
modely.fit(x2, y2, batch_size=1, epochs=10)
...
# Train the model
modelz.fit(x3, y3, batch_size=1, epochs=10)
